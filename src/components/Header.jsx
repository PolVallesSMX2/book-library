...
const Header = ({ availableCount, readingCount }) => {
  return (
    <header className='mx-5 mb-3 flex flex-row justify-between items-center'>
        <div>
        ...
        <div className=''>
          <a href="https://github.com/PolVallesSMX2/book-library" target='_blank' className='flex flex-row gap-3 items-center'>
            Github
            <svg className='w-9' viewBox="0 0 1024 1024" fill="#ffffff" xmlns="http://www.w3.org/2000/svg">
